...
all_col_names = ["delivery_wid",
                ...
                "src_leads",
                "src_link_clicks",
                "src_messaging_conversation_started_7d",
                ...
                "src_page_engagement",
                "src_event_responses",
                "src_other_conversions",
                "src_catalog_mobile_purchase",
                "src_catalog_mobile_purchase_value",
                "src_purchase_total",
                "src_purchase_total_value",
                "src_fb_mobile_purchase_value",
                "src_subscribe_total",
                "src_subscribe_total_revenue",
                "src_contact_total",
                "src_start_trial_total",
                "src_submit_application_total",
                "src_schedule_total",
                "src_website_add_to_wishlist",
                "src_website_complete_registration",
                "src_omni_add_to_cart",
                "src_omni_initiated_checkout",
                "src_omni_search",
                "src_omni_view_content",
                "src_fb_mobile_level_achieved",
                "src_fb_mobile_spent_credits",
                "src_donate_total",
                "src_donate_total_value",
                "src_find_locations",
                "src_lead_value",
                "src_offline_complete_registration",
                "src_registrations_completed",
                "date_wid",
                "data_as_of_ts",
                "file_name",
                "file_row_number",
...
class DeliveryMetaAd(Delivery):
    '''loads fct_delivery_meta_lineitem_ad_daily_mapped'''
    ...
    def merge_data(self, target, mapped_delivery_df):
        ...
        target.merge(mapped_delivery_df,
                    ...
                    (target["meta_ad_id"] == mapped_delivery_df["meta_ad_id"]) &
                    ...
                    [F.when_matched().update({
                                            "ads_account_currency": mapped_delivery_df["ads_account_currency"],
                                            "ads_account_name": mapped_delivery_df["ads_account_name"],
                                            "attribution_setting": mapped_delivery_df["attribution_setting"],
                                            "campaign_type": mapped_delivery_df["campaign_type"],
                                            "src_post_save": mapped_delivery_df["src_post_save"],
                                            ...
                                            "src_likes": mapped_delivery_df["src_likes"],
                                            ...
                                            "src_outbound_clicks": mapped_delivery_df["src_outbound_clicks"],
                                            ...
                                            "src_messaging_conversation_started_7d": mapped_delivery_df["src_messaging_conversation_started_7d"],
                                            ...
                                            "src_other_conversions": mapped_delivery_df["src_other_conversions"],
                                            "src_catalog_mobile_purchase": mapped_delivery_df["src_catalog_mobile_purchase"],
                                            "src_catalog_mobile_purchase_value": mapped_delivery_df["src_catalog_mobile_purchase_value"],
                                            "src_purchase_total": mapped_delivery_df["src_purchase_total"],
                                            "src_purchase_total_value": mapped_delivery_df["src_purchase_total_value"],
                                            "src_fb_mobile_purchase_value": mapped_delivery_df["src_fb_mobile_purchase_value"],
                                            "src_subscribe_total": mapped_delivery_df["src_subscribe_total"],
                                            "src_subscribe_total_revenue": mapped_delivery_df["src_subscribe_total_revenue"],
                                            ...
                                            "src_website_add_to_wishlist": mapped_delivery_df["src_website_add_to_wishlist"],
                                            "src_website_complete_registration": mapped_delivery_df["src_website_complete_registration"],
                                            "src_omni_add_to_cart": mapped_delivery_df["src_omni_add_to_cart"],
                                            "src_omni_initiated_checkout": mapped_delivery_df["src_omni_initiated_checkout"],
                                            "src_omni_search": mapped_delivery_df["src_omni_search"],
                                            "src_omni_view_content": mapped_delivery_df["src_omni_view_content"],
                                            "src_fb_mobile_level_achieved": mapped_delivery_df["src_fb_mobile_level_achieved"],
                                            "src_fb_mobile_spent_credits": mapped_delivery_df["src_fb_mobile_spent_credits"],
                                            "src_donate_total": mapped_delivery_df["src_donate_total"],
                                            "src_donate_total_value": mapped_delivery_df["src_donate_total_value"],
                                            "src_find_locations": mapped_delivery_df["src_find_locations"],
                                            "src_lead_value": mapped_delivery_df["src_lead_value"],
                                            "src_offline_complete_registration": mapped_delivery_df["src_offline_complete_registration"],
                                            "src_registrations_completed": mapped_delivery_df["src_registrations_completed"],
                      ...
                      F.when_not_matched().insert({"delivery_wid" : mapped_delivery_df["delivery_wid"],
                                                ...
                                                "meta_ad_wid" : mapped_delivery_df["meta_ad_wid"],
                                                ...
                                                "meta_ad_id" : mapped_delivery_df["meta_ad_id"],
    ...
    def get_all_metrics(self, df, batch_id):
        ...
        final_df = (df
                    .withColumnRenamed("external_ad_id", "meta_ad_id")
                    .withColumnRenamed("external_adset_id", "meta_ad_set_id")
                    .withColumnRenamed("external_campaign_id", "meta_campaign_id")
                    .withColumn("meta_ad_wid", F.sha1(F.concat(F.col("integration_source_code"),
                                                                     F.col("agency_id"),
                                                                     F.col("meta_ad_id"),
    ...
    def process_incr_raw_delivery(self, session, logger, target, get_all_metrics_fn, integration_source_code):
        ...
        var_raw_delivery_stream    = "meta_lineitem_ad_daily_msg_mcl_stream"
    ...
    def save_data(self, session, logger, batch_id):
        ...
        var_line_item_tracker_name  = "meta_lineitem_ad_daily_lm_stream"
        var_target_table_name       = "fct_delivery_meta_lineitem_ad_daily_mapped"
        var_raw_delivery_table_name = "msg_delivery_meta_ad_latest"
