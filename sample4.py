...
class DeliveryMetaCampaign(Delivery):
    '''loads fct_delivery_meta_lineitem_campaign_daily_mapped'''
    ...
    def merge_data(self, target, mapped_delivery_df):
        ...
        target.merge(mapped_delivery_df,
                    ...
                    [F.when_matched().update({
                                            "account_currency": mapped_delivery_df["account_currency"],
                                            ...
                                            "src_rsvp_value": mapped_delivery_df["src_rsvp_value"],
                                            ...
                                            "src_post_saves": mapped_delivery_df["src_post_saves"],
    ...
    def process_incr_raw_delivery(self, session, logger, target, get_all_metrics_fn, integration_source_code):
        ...
        var_raw_delivery_stream    = "meta_lineitem_campaign_daily_msg_mcl_stream"
    ...
    def save_data(self, session, logger, batch_id):
        ...
        var_line_item_tracker_name  = "meta_lineitem_campaign_daily_lm_stream"
        var_target_table_name       = "fct_delivery_meta_lineitem_campaign_daily_mapped"
        var_raw_delivery_table_name = "msg_delivery_meta_campaign_latest"
        integration_source_code     = "facebook_ad_server"
        var_reload_stream_name      = "meta_lineitem_campaign_daily_rid_stream"
